  ...
  return (
    <>
      {localStorage.getItem("signIn") === "true" && (
        <div className="relative h-svh bg-slate-950 ">
          ...
          <div className="h-full w-full absolute overflow-y-auto scroll-smooth">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-8">
              {products
                ...
                .map((product) => (
                  <div
                    className="min-w-[300px] max-w-[300px] h-96 mx-auto bg-white rounded-xl shadow-md overflow-hidden flex flex-col z-10"
                    key={product._id}
                  >
                    {/* Card Header */}
